...
const Kbd = ({children}: {children: React.ReactNode}) => (
	<kbd className="mr-1 inline-block whitespace-nowrap rounded border border-slate-400 px-1.5 align-middle text-xs font-medium leading-4 tracking-wide text-slate-600 dark:border-slate-500 dark:text-slate-400">
		{children}
	</kbd>
);
		...
		<>
			...
			<ul className="DocSearch-Commands">
				<li>
					...
					<span className="DocSearch-Label text-slate-600 dark:text-slate-400">
						{selectText}
					</span>
				</li>
				<li>
