  ...
  return (
    <>
      ...
      >
        ...
        {!props.state.query && <kbd className="inline-block whitespace-nowrap rounded border border-slate-500 px-1.5 align-middle text-xs font-medium leading-4 tracking-wide text-slate-500">
          ESC
        </kbd>}
