...
export const Search = () => {
	...
	return (
		<KBarButton>
			<div className="dark:md:bg-dark-bg-1 dark:md:ring-dark-border md:ring-light-border group flex h-6 w-6 items-center justify-center sm:justify-start md:h-auto md:w-80 md:flex-none md:rounded-lg md:py-2.5 md:pl-4 md:pr-3.5 md:text-sm md:ring-1 md:hover:ring-slate-400 dark:md:ring-inset dark:md:hover:ring-slate-500 lg:w-96">
