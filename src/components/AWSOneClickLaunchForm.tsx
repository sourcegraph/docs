...
export default function AWSOneClickLaunchForm() {
  ...
  return (
    ...
    <form
      action=""
      className="launcher flex items-center justify-start w-full gap-4"
      name="launcher"
      target="_blank"
      onSubmit={handleSubmit}
    >
      <Select value={region} onValueChange={setRegion}>
        <SelectTrigger className="py-5 w-1/2 ring ring-[#ff9900]/10">
      ...
      <Button type="submit" className="bg-[#ff9900] text-black">AWS Launch Stack</Button>
    </form>
    // </div>
  );
}
