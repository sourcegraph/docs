...
export function PromptForm({
  ...
  return (
    <form
      ...
      ref={formRef}
    >
      <div className="bg-background dark:bg-dark-bg relative flex max-h-60 w-full grow flex-col overflow-hidden px-2 pb-2 sm:rounded-2xl sm:border">
        <div className="flex w-full flex-col">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 md:justify-start">
              ...
              {/* Send button */}
              <Button type="submit" className='bg-[#08b2c9] hover:bg-[#3ecde0]' disabled={isLoading || input === ''}>
                {isLoading ? (
                  <IconSpinner />
                ) : (
