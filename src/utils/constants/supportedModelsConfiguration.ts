export const chatTableDataConf: any = {
    'Sourcegraph': [
        ...
        { provider: 'Anthropic', model: 'Claude-2.0', status: 'anthropic/claude-2.0' },
        { provider: 'Anthropic', model: 'claude-2.1 (See Note #2)', status: 'anthropic/claude-2.1' },
    ...
    'Azure OpenAI': [
        { provider: 'OpenAI', model: 'gpt-3.5 turbo', status: '❌' },
        { provider: 'OpenAI', model: 'gpt-4', status: '<deployment name of the model> (See Note #1)' },
        { provider: 'OpenAI', model: 'gpt-4 turbo', status: '<deployment name of the model> (See Note #1)' },
        { provider: 'OpenAI', model: 'gpt-4o', status: '<deployment name of the model> (See Note #1) *(5.4.5099 and above)' },
        { provider: 'Anthropic', model: 'Claude-Instant-1.2', status: '❌' },
        { provider: 'Anthropic', model: 'Claude-2.0', status: '❌' },
        { provider: 'Anthropic', model: 'claude-2.1 (See Note #2)', status: '❌' },
        { provider: 'Anthropic', model: 'claude-3 Sonnet', status: '❌' },
    ...
    'Amazon Bedrock': [
        ...
        { provider: 'Anthropic', model: 'Claude-2.0', status: 'anthropic.claude-v2' },
        { provider: 'Anthropic', model: 'claude-2.1 (See Note #2)', status: 'anthropic.claude-v2:1' },
...
export const autocompleteTableDataConf: any = {
    ...
    'Azure OpenAI': [
        ...
        { provider: 'OpenAI', model: 'gpt-3.5 turbo', status: '<deployment name of the model>' },
        { provider: 'OpenAI', model: 'gpt-4', status: '<deployment name of the model> (Note #6)' },
        { provider: 'OpenAI', model: 'gpt-4 turbo', status: '<deployment name of the model> (Note #6)' },
        { provider: 'OpenAI', model: 'gpt-4o', status: '<deployment name of the model> (Note #6)' },
        { provider: 'Fireworks', model: 'StarCoder', status: '❌' },
        { provider: 'Fireworks', model: 'DeepSeek Coder V2', status: '❌' },
        { provider: 'Anthropic', model: 'Claude-Instant-1.2', status: '❌' },
        { provider: 'Ollama*', model: 'variety', status: '❌' }
