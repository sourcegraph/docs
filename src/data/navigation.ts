		...
		topics: [
			{
				...
				sections: [
					...
					{
						title: "Model Configuration", href: "/cody/model-configuration",
						subsections: [
							{ title: "Examples", href: "/cody/model-configuration/examples", },
						]
					},
					{
		...
		topics: [
				...
				sections: [
					{ title: 'Quickstart', href: '/cody/quickstart' },
					{
						...
						subsections: [
							...
							{
								title: 'Cody for Neovim',
								href: '/cody/clients/install-neovim'
							},
							{
								title: 'Cody for Web',
							...
							},
							{
								...
								href: '/cody/clients/model-configuration'
							}
						]
					},
					{
						...
						subsections: [
							...
							{
								title: 'Commands',
								href: '/cody/capabilities/commands'
							},
							{
								title: 'Debug Code',
			...
			},
			{
				...
				sections: [
					{
						title: 'Features',
						href: '/code_navigation/explanations/features'
					},
					{
						title: 'Search-based code navigation',
						href: '/code_navigation/explanations/search_based_code_navigation'
					},
					{
						title: 'Precise code navigation',
						href: '/code_navigation/explanations/precise_code_navigation'
					},
					{
						title: 'Indexers',
						href: '/code_navigation/explanations/writing_an_indexer'
					},
					{
						title: 'Auto-indexing',
						href: '/code_navigation/explanations/auto_indexing'
					},
					{
						title: 'Environment Variables',
						href: '/code_navigation/references/envvars'
					},
					{
						title: 'Troubleshooting',
						href: '/code_navigation/references/troubleshooting'
					}
				]
			}
		]
		...
		topics: [
			{
				...
				sections: [
					...
					{
						title: 'Explanations',
						href: '/batch_changes/explanations'
					},
				...
				sections: [
					...
					},
					{
						...
						subsections: [
							...
							{
								title: 'Indexers',
								href: '/code-search/code-navigation/writing_an_indexer'
							},
							{
								title: 'Auto-indexing',
