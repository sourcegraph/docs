/**
 * The changelog now lives on sourcegraph.com. The docs site no longer hosts
 * /technical-changelog; requests for it redirect here.
 */
export const CHANGELOG_URL = 'https://sourcegraph.com/changelog';
