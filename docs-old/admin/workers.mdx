...
This job periodically checks for repositories that can be auto-indexed and queues indexing jobs for a remote executor instance to perform. Read how to [enable](/code_navigation/how-to/enable_auto_indexing) and [configure](/code_navigation/how-to/configure_auto_indexing) auto-indexing.
...
This job periodically checks for dependency packages that can be auto-indexed and queues indexing jobs for a remote executor instance to perform. Read how to [enable](/code_navigation/how-to/enable_auto_indexing) and [configure](/code_navigation/how-to/configure_auto_indexing) auto-indexing.
