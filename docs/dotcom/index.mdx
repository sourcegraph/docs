...
To use Sourcegraph on your own (private) code, [use Sourcegraph Cloud](/cloud/) or [deploy self-hosted Sourcegraph](/self-hosted/deploy/).

-   [Indexing open source code in Sourcegraph.com](/dotcom/indexing-open-source-code)
