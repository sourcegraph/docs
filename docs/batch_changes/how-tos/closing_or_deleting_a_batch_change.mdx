...
1. In the top right, click the **Close** button.
    ...
    <img src="https://sourcegraphstatic.com/docs/images/batch_changes/closing_batch_change_close_icon.png" />
1. Select whether you want to close all of the batch change's open changesets (e.g., closing all associated GitHub pull requests on the code host).
    ...
    <img src="https://sourcegraphstatic.com/docs/images/batch_changes/closing_batch_change_close_changesets.png" />
...
1. Instead of a "Close batch change" button you'll now see a **Delete** button.
    ...
    <img src="https://sourcegraphstatic.com/docs/images/batch_changes/closing_batch_change_deleting.png" />
1. Click **Delete**.
