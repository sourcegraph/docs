...
The updated [`repo:` keyword](/batch_changes/how-/batch_changes/code_search/reference/queries#keywords-all-searches) in the search query will result in more repositories being returned by the search.
