...
Enterprise users continue to sign in to their Sourcegraph instance using its configured authentication, including built-in SSO. A separate Sourcegraph Account is required to access Sourcegraph-operated services such as Enterprise Portal and Sourcegraph Analytics.
