...
<Callout type="note">
	Detect and track patterns' insights are available in Sourcegraph v3.35 and
	above. In Sourcegraph v3.35 this feature is in its earliest version.
	Stability and additional features coming in following releases.
</Callout>
