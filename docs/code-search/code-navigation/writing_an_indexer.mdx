...
<p className="subtitle">This page describes the [SCIP Code Intelligence Protocol](https://github.com/sourcegraph/scip)
and how you can write an indexer to emit SCIP.</p>
...
| C/C++        | scip-clang      | 🟡          | ✓              | ✓                    | ✓                   | ✓              | ✓                    | ✗                        | [See notes](https://github.com/sourcegraph/scip-clang#supported-platforms)                           |
| Java         | scip-java       | 🟢          | ✓              | ✓                    | ✓                   | ✓*             | ✓                    | ✓                        | [See notes](https://sourcegraph.github.io/scip-java/docs/getting-started.html#supported-build-tools) |
| Scala        | scip-java       | 🟢          | ✓              | ✓                    | ✓                   | ✓*             | ✓                    | ✓                        | [See notes](https://sourcegraph.github.io/scip-java/docs/getting-started.html#supported-build-tools) |
| Kotlin       | scip-java       | 🟢          | ✓              | ✓                    | ✓                   | ✓*             | ✗                    | ✓                        | [See notes](https://sourcegraph.github.io/scip-java/docs/getting-started.html#supported-build-tools) |
| Rust         | rust-analyzer   | 🟢          | ✓              | ✓                    | ✓                   | ✓*             | ✗                    | ✓                        | [See notes](https://rust-analyzer.github.io/)                                                        |
| Python       | scip-python     | 🟢          | ✓              | ✓                    | ✓                   | ✓              | ✓                    | ✓                        | [See notes](https://github.com/sourcegraph/scip-python)                                              |
| Ruby         | scip-ruby       | 🟢          | ✓              | ✓                    | ✓                   | ✓              | ✗                    | ✓                        | [See notes](https://github.com/sourcegraph/scip-ruby#scip-ruby)                                      |
| C#           | scip-dotnet     | 🟠          | ✓              | ✓                    | ✓                   | ✗              | ✓                    | ✓                        | `.sln` and `.csproj`                                                                                 |

<Callout type="info">Requires enabling and setting up Sourcegraph's auto-indexing feature. Read more about [Auto-indexing](/code_navigation/explanations/auto_indexing).</Callout>
...
<QuickLinks>
  ...
  <QuickLink href="/code-search/code-navigation/explanations/uploads" icon="theming" imgAlt="Code Navigation" title="Code Graph Data uploads" description="Learn how Code Graph indexers analyze code and generate an index file." />
   <QuickLink href="/code-search/code-navigation/how-to/configure_data_retention" icon="installation" imgAlt="Code Navigation" title="Configure code graph data retention policies" description="Configure retention policies of your code graph data to prevent old data from taking up valuable space in the database."/>
</QuickLinks>
