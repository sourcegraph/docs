...
<QuickLinks>
	...
	<QuickLink href="/code-search/code-navigation/inference_configuration" icon="lightbulb" imgAlt="Code Navigation" title="Auto-indexing inference configuration reference" description="Guide for site administrators on customizing code intelligence indexing jobs detection in Sourcegraph by supplying a Lua script for repository content analysis." />
</QuickLinks>
