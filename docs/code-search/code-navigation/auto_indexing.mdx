...
<Callout type="note">
	...
	guide](/code-search/code-navigation/how-to/policies_resource_usage_best_practices)
	for additional details on how policies affect resource usage.
</Callout>
...
<QuickLinks>
	...
	/>
	<QuickLink
		href="/code-search/code-navigation/explanations/auto_indexing_inference"
		icon="lightbulb"
		imgAlt="Code Navigation"
	...
	/>
	<QuickLink
		href="/code-search/code-navigation/inference_configuration"
		icon="theming"
		imgAlt="Code Navigation"
	...
	/>
	<QuickLink
		href="/code-search/code-navigation/how-to/combining_scip_uploads_from_ci_cd_and_auto_indexing"
		icon="presets"
		imgAlt="Code Navigation"
	...
	/>
	<QuickLink
		href="/code-search/code-navigation/how-to/policies_resource_usage_best_practices"
		icon="installation"
		imgAlt="Code Navigation"
