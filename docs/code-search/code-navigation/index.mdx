...
<QuickLinks>
  ...
  <QuickLink href="/code_navigation/references/indexers" icon="theming" imgAlt="Code Navigation" title="Indexers" description="Learn how SCIP Code Intelligence Protocol works and how you can write an indexer to emit SCIP." />
</QuickLinks>
...
| [Dependency navigation](/code_navigation/explanations/features#dependency-navigation) (Experimental) | Extends code navigation to work across [packages](/admin/external_service/package-repos)  |
