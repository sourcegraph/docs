...
| `ROCKSKIP_REPOS`     | N/A                              | In combination with `USE_ROCKSKIP=true` this specifies a comma-separated list of repositories to index using [Rockskip](/code_navigation/explanations/rockskip)                              |
