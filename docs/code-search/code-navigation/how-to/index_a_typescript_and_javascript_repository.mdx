...
<p className="subtitle">This page describes how to create an index for JavaScript and TypeScript projects and uploading it to Sourcegraph.</p>
...
<Callout type="note">`src-cli` ignores index upload failures by default to avoid disrupting CI pipelines with non-critical errors.</Callout>
...
4. Upload the data to a Sourcegraph instance.
  ...
  ```sh
    SRC_ENDPOINT=<your sourcegraph endpoint> src code-intel upload # for private instances
