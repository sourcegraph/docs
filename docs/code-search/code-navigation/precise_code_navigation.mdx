...
Precise code navigation relies on the following technologies:

- [SCIP](https://github.com/sourcegraph/scip) (SCIP Code Intelligence Protocol) and
- [LSIF](https://github.com/Microsoft/language-server-protocol/blob/master/indexFormat/specification)
...
- [Writing an SCIP indexer](/code-search/code-navigation/writing_an_indexer)

## More resources

<QuickLinks>
    <QuickLink href="/code-search/code-navigation/writing_an_indexer" icon="installation" imgAlt="Code Navigation" title="Writing an SCIP indexer" description="Learn how you can write an indexer to emit SCIP with Sourcegraph." />
    ...
    <QuickLink href="/code-search/code-navigation/how-to/adding_lsif_to_many_repos" icon="presets" imgAlt="Code Navigation" title="Add precise indexing to multiple repos" description="Learn how to add precise indexing to multiple repos to Sourcegraph." />
</QuickLinks>
