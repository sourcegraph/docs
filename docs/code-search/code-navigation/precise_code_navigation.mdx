...
<Callout type="info">
	...
	indexer](/code-search/code-navigation/writing_an_indexer#quick-reference)
	for your language. Code and build systems can vary by project and ensuring
	you can first succesfully run the indexer locally leads to a smoother
	experience since it is vastly easier to debug and iterate on any issues
	locally before trying to do so in CI/CD or in Auto-Indexing.
</Callout>
...
<QuickLinks>
	...
	/>
	<QuickLink
		href="/code-search/code-navigation/how-to/adding_scip_to_workflows"
		icon="lightbulb"
		imgAlt="Code Navigation"
