...
<p className="subtitle">Learn and understand more about Sourcegraph's Code Navigation features and core functionality.</p>
...
<Callout type="note">This feature is in Beta stage and is not available for other language ecosystems.</Callout>
...
* **Go**: Set up [auto-indexing](/code_navigation/explanations/auto_indexing).
* **Java, Scala, Kotlin**: Set up [auto-indexing](/code_navigation/explanations/auto_indexing) and a [JVM dependencies code host](/integration/jvm).
* **JavaScript, TypeScript**: Set up [auto-indexing](/code_navigation/explanations/auto_indexing) and a [npm dependencies code host](/integration/npm).
...
<Callout type="note">Read [here](/code_navigation/references/indexers#quick-reference) for an overview of which languages support this feature.</Callout>
