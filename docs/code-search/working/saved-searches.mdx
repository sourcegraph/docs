...
<p className="subtitle">
	Saved Searches lets you reuse and share search queries.
</p>

You can create a saved search for anything, including diffs and commits across all branches of your repositories.

To access or create new Saved Searches in Sourcegraph, click the **More > Saved Searches** in the navigation bar.

![saved-searches](https://storage.googleapis.com/sourcegraph-assets/Docs/saved-searches-2025.png)
