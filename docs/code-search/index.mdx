...
<QuickLink title="Search Query Syntax" icon='lightbulb' href="/code-search/queries" description="Learn about the search pattern syntax and keywords available for Code Search." />

<QuickLink title="Search Types" icon='presets' href="/code-search/types" description="Learn about the different search types that you can perform with Code Search." />

<QuickLink title="Working with Search" icon='installation' href="/code-search/working" description="Learn about performing advanced search queries and use search filters to narrow your search results." />
