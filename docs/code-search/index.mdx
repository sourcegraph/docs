...
<QuickLink title="Search Examples" icon='theming' href="/code-search/queries/examples" description="Learn about some common search use cases and examples." />

<QuickLink title="Features" icon='presets' href="/code-search/features" description="Learn about the core search features." />

<QuickLink title="Advanced Features" icon='installation' href="/code-search/working/saved_searches" description="Learn about advanced features like saved searches and search contexts." />
