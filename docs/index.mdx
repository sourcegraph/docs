...
<QuickLinks>
	...
	<QuickLink href="https://sourcegraph.com/search" icon="codesearch" imgAlt="Code Search" title="Try Code Search" description="Search all of your repositories across all branches and all code hosts." />
