...
Refer to the [interface definitions of our typescript client](TODO/UPDATE SOURCEGRAPH SEARCH LINK/-/blob/client/shared/src/search/stream.ts?L12) to learn about the schema of the event-types.
