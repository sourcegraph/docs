...
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| access token / oauth token      | [Sourcegraph access token](/cli/how-tos/creating-an-access-token) or [OAuth token](/admin/oauth-apps) with `user:all` scope. See [GraphQL API authentication](/api/graphql#quickstart) for details on token refresh and expiration handling.                                                                                                                                          |
