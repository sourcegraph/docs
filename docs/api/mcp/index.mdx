...
<Callout type="note">
By setting the environment variable `SRC_MCP_DISABLE_DEEPSEARCH_TOOL` to `true` an Admin can disable this tool and it will not appear as part of the MCP tool list for agents to use.
</Callout>
