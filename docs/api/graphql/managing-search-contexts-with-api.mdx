...
Learn how to manage [search contexts](/code_search/how-to/search_contexts) on private Sourcegraph instances with the API. If you haven't used the API before, learn more about [the GraphQL API and how to use it](/api/graphql/).
