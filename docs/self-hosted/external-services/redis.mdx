...
**Version requirements**: We support any version _starting from 6.2_. Redis Cluster and Redis Sentinel are not supported.
...
```
docker run [...]
  -e REDIS_ENDPOINT=redis.example.com:6379
...
-   See our documentation for Kubernetes [here](/self-hosted/deploy/kubernetes/configure#external-redis)
-   **Related:** [How to Set a Password for Redis using a ConfigMap](/self-hosted/how-to/redis-configmap)
