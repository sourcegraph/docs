...
Scratch line to exercise the check: visit https://your-sourcegraph-instance.com/settings, then `SRC_ENDPOINT=<your sourcegraph endpoint>` and grafana.mycompany.com.
