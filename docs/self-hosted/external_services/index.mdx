...
-   See [Using your own PostgreSQL server](/self-hosted/external_services/postgres) to replace the bundled PostgreSQL instances.
-   See [Using your own Redis server](/self-hosted/external_services/redis) to replace the bundled Redis instances.
-   See [Using a managed object storage service (S3 or GCS)](/self-hosted/external_services/object_storage) to replace the bundled blobstore instance.
