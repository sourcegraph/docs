...
> **Note:** For versions prior to 6.12.0, you could also use autoupgrade by setting the environment variable `SRC_AUTOUPGRADE_IGNORE_DRIFT=true` on the sourcegraph container. Autoupgrade has been removed in Sourcegraph 6.12.0 and later.
