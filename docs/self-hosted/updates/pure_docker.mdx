...
1. Read our [update policy](/admin/updates/#update-policy) to learn about Sourcegraph updates.
...
1. Update image tags to `3.15.1`. Change `all sourcegraph/` image tags to `3.15.1`. This includes all images you previously had as `3.14.2` AND all `sourcegraph/<service>` images:
