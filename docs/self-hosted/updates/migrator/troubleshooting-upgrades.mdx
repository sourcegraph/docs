...
If you have conducted an upgrade and see drift in your `Site admin -> Updates` page please report it to us. This is generally not a major cause of concern but may indicate problems in our `migrator` schema migration _squashing_ logic.
...
Once a failing migration error message can be found, follow the guide on [how to troubleshoot a dirty database](/self-hosted/how-to/dirty_database).
