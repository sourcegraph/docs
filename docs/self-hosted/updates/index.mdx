...
-   **Sourcegraph with Docker Compose**
    ...
    -   [Upgrade Notes](/self-hosted/updates/docker_compose)
...
-   [**Pure-docker custom deployments**](/self-hosted/updates/pure_docker)
...
-   [Postgres 12 End Of Life Notice](/self-hosted/postgres12_end_of_life_notice)
