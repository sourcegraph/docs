...
- <span class="badge badge-warning">warning</span> searcher: 60%+ process memory map areas percentage used (per instance)
- <span class="badge badge-critical">critical</span> searcher: 80%+ process memory map areas percentage used (per instance)
