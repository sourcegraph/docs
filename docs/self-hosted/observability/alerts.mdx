...
- This indicates a bug in Sourcegraph; please contact support.
...
- If the rule group taking a long time to evaluate belongs to `/sg_config_prometheus`, please contact support.
