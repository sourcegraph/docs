...
If Sourcegraph's builtin [alerting](/self-hosted/observability/alerting) (which can notify you via email, Slack, PagerDuty, webhook, and more) is not sufficient for you, or if you just prefer to consume the alerts programatically for some reason, then this page is for you.
