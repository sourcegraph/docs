...
Learn more about how to apply these environment variables in [docker-compose](/self-hosted/deploy/docker-compose/configuration#set-environment-variables) deployments.
