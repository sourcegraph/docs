...
The following commands assume a connection to the `frontend` database. Refer to our guide on [`psql`](/self-hosted/how-to/run-psql) if you do not use an [external database](/self-hosted/external_services/).
...
The following commands assume a connection to the `codeintel-db` database. Refer to our guide on [`psql`](/self-hosted/how-to/run-psql) if you do not use an [external database](/self-hosted/external_services/).
