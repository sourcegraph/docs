...
If you recently updated to Sourcegraph v4.2.1+, please be sure to look at the [blobstore update notes](/self-hosted/how-to/blobstore_update_notes)
...
Today, Sourcegraph uses blobstore for storing precise code intel (LSIF/SCIP) uploads. You can also configure Sourcegraph to use [S3 or GCS for object storage](/self-hosted/external_services/object_storage) if you prefer.
