...
> NOTE: You can refer to the following instructions for accessing databases on your deployment type: [Docker Compose](/admin/deploy/docker-compose/#access-the-database), [Kubernetes](/self-hosted/deploy/kubernetes/operations#access-the-database).
