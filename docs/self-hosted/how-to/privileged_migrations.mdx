...
You can manually [find and apply the target privileged migrations](/self-hosted/how-to/dirty_database#2-run-the-sql-queries-to-finish-incomplete-migrations) and [manually add a migration log entry](/self-hosted/how-to/dirty_database#3-add-a-migration-log-entry).
