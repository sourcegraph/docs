...
-   [Docs: Configure custom Redis](/self-hosted/deploy/kubernetes/configure#external-redis)
-   [Docs: Using your own Redis server](/self-hosted/external_services/redis)
...
data:
  redis.conf: |
    ...
    ## Customization ##
    ###################
    requirepass demopasswordchangeme123</b>
