...
-   [Docker single container](/self-hosted/deploy/docker-single-container/) (removed in 7.0.0)
...
-   [Server upgrades](https://sourcegraph.com/changelog/self-hosted/server) (removed in 7.0.0)
