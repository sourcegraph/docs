...
When that is done, update your DNS records to point to your gateway's external IP, and change the following line in your [site configuration](/admin/config/site_config):
