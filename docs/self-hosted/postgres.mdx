...
**For instance specific instructions on how to upgrade a builtin Postgres database via the image entrypoint script, see [our instance specific operational instructions](/self-hosted/how-to/upgrade-postgres-12-16-builtin-dbs).**
...
-   [EnterpriseDB](https://www.enterprisedb.com/docs/pgd/latest/upgrades/)
-   [Citus](https://docs.citusdata.com/en/v8.1/admin_guide/upgrading_citus.html)
...
<Callout type="warning">The single-container (`sourcegraph/server`) deployment mode has been removed in [Sourcegraph 7.0.0](https://sourcegraph.com/changelog/releases/7.0). [Migrate to Docker Compose](/self-hosted/deploy/docker-compose/migrate) or [Kubernetes](/self-hosted/deploy/kubernetes/).</Callout>
