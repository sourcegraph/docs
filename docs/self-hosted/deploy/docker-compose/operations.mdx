...
-   [Storage and backups for Amazon Web Services](/self-hosted/deploy/docker-compose/aws)
-   [Storage and backups for Azure](/self-hosted/deploy/docker-compose/azure#storage-and-backups)
