...
1. Select an appropriate droplet size using our [resource estimator](/self-hosted/deploy/resource-estimator) as reference
...
-   Set up [TLS/SSL](/self-hosted/http-https-configuration#sourcegraph-via-docker-compose-caddy-2) in the Docker Compose deployment
