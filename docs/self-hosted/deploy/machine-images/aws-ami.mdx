...
<img
	width="1256"
	alt="Screenshot 2025-05-06 at 3 52 51 PM"
	src="https://github.com/user-attachments/assets/8e98792b-16d9-4c0c-a3a1-981246a811b8"
/>
...
<Callout type="warning">
	...
	upgrades at this time, nor do they support Automatic Upgrade State. The
	Automatic Upgrade State toggle can be found on your Sourcegraph instance's
	`site-admin/updates` screen.
</Callout>
