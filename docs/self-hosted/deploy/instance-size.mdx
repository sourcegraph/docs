...
Please refer to our [resource estimator](/self-hosted/deploy/resource_estimator) for more information regarding resources allocation for your Sourcegraph deployment.
