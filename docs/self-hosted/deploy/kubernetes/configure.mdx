...
**Step 1:** To update all image names with your private registry, e.g. `index.docker.io/sourcegraph/service_name` to `registry.example.com/sourcegraph/service_name`, include the `private-registry` component:
...
# instances/$INSTANCE_NAME/buildConfig.yaml
data:
    PRIVATE_REGISTRY: registry.example.com # -- Replace 'registry.example.com'
```
