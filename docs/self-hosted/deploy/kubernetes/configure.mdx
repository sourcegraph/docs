...
By default, all Sourcegraph services are deployed in a non-root and non-privileged mode, as defined in the [base](https://github.com/sourcegraph/deploy-sourcegraph-k8s/tree/master/base) cluster.
