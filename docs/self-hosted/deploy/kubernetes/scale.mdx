...
For production environments, we recommend allocate resources based on your [instance size](/self-hosted/deploy/instance-size). See our [resource estimator](/self-hosted/deploy/resource_estimator) for estimates.
