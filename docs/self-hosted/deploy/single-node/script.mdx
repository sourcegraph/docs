...
curated [Machine Images](/self-hosted/deploy/machine-images/) if possible.
...
<span class="badge badge-critical">IMPORTANT</span> For optimal performance both
disks should be backed by SSDs or equivalently fast storage.
...
We strongly recommend taking snapshots of the data disk on an automatic, scheduled basis.
