...
See [expose debug port in Docker Compose](/self-hosted/deploy/docker-compose/configuration#expose-debug-port).

### Sourcegraph with Kubernetes

If you're using the [Kubernetes cluster deployment](/self-hosted/deploy/kubernetes/),
