...
-   [Redirect to external HTTPS URL](/self-hosted/http_https_configuration#redirect-to-external-https-url)
-   [NGINX HTTP Strict Transport Security](/self-hosted/http_https_configuration#redirect-to-external-https-url)
