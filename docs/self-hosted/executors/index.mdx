...
-   [Automatically indexing a repository for precise code navigation](/code-navigation/auto_indexing)
...
Running untrusted code is a core requirement of features such as precise code navigation [auto-indexing](/code-navigation/auto_indexing), and [running batch changes server-side](/batch-changes/server-side).
...
Refer to the [Troubleshooting Executors](/self-hosted/executors/executors_troubleshooting) document for common debugging operations.
