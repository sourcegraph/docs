...
![Executors architecture - local with src-cli](https://storage.googleapis.com/sourcegraph-assets/executor_src_local_arch.png)
...
![Executors architecture - binary](https://storage.googleapis.com/sourcegraph-assets/executor_binary_arch.png)
...
![Executors architecture - firecracker](https://storage.googleapis.com/sourcegraph-assets/executor_firecracker_arch.png)
...
![Executors architecture - docker](https://storage.googleapis.com/sourcegraph-assets/executor_docker_arch.png)
