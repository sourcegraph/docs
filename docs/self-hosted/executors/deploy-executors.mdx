...
-   Terraform ([Firecracker](./firecracker) compatible): [AWS](/self-hosted/executors/deploy-executors-terraform-aws) | [Google Cloud](/self-hosted/executors/deploy-executors-terraform-gcp)
...
<QuickLinks>
	<QuickLink
		...
		description="Launch executors on AWS using the Sourcegraph-maintained Terraform module and machine images."
	/>
	<QuickLink
		title="Terraform (Google Cloud)"
		icon="lightbulb"
		href="/self-hosted/executors/deploy-executors-terraform-gcp"
		description="Launch executors on Google Cloud using the Sourcegraph-maintained Terraform module and machine images."
	/>
	<QuickLink
