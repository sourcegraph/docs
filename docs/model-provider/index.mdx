...
<Callout type="note">The Sourcegraph model provider is also referred to as "Cody Gateway", which is the LLM proxy service that provides this capability.</Callout>
