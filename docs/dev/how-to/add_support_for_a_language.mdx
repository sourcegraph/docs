...
To support precise code navigation, [write an SCIP indexer](/code_navigation/explanations/writing_an_indexer). To support search-based code navigation, ensure the language is registered in the code navigation APIs:
...
To add syntax highlighting on a new language follow the following steps in the [sourcegraph/sourcegraph](https://github.com/sourcegraph/sourcegraph) repository.
