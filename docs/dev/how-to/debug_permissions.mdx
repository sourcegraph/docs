...
![](https://storage.googleapis.com/sourcegraph-assets/Docs/how-to/debug-permissions/gitlab_connection.png)
    ...
    - Not all authorization configurations are the same. Visit the code hosts docs page for more detailed information on configuring authorization for the specific code host you’re dealing with.
