...
Adding dashboards, panels, etc. to this image is handled by the [monitoring generator](/dev/background-information/observability/monitoring-generator).
...
To learn more about building dashboards, see the [observability developer guides](/dev/background-information/observability/#guides).
...
1. [Run the monitoring stack locally](/dev/how-to/monitoring_local_dev) and verify that all generated Grafana dashboards still render correctly
