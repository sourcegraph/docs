...
If memory issues persist after disabling ownership features, consider whether Own functionality is essential for your use case, as temporarily disabling these features may be preferable to system instability.
