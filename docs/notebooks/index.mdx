...
<LinkCards>
  <LinkCard href="quickstart" imgSrc="https://sourcegraph.com/.assets/img/sourcegraph-mark.svg" imgAlt="Quickstart" title="Quickstart" description="Learn how to quickly get started with Notebooks." />
</LinkCards>
