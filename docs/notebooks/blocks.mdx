...
## Query blocks
Query blocks support the full Sourcegraph search query language, allowing you to use our full [search syntax](/code_search/reference), including any of our types, filters, patterns, and predicates, to display the most relevant results.
