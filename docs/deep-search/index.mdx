...
<Callout type="warning">
	...
	fallback exists via the `deepsearch-streaming` feature flag, but it will be
	removed in a future release. Ensure your ingress or proxy timeout is raised to
	at least 5 minutes before enabling Deep Search for your users.
</Callout>
