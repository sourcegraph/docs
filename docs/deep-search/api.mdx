...
4. **Resource identifiers**: Numeric IDs (`140`) → resource names (`users/{username}/conversations/140`)
...
| Old field              | New field                                    |
| ---------------------- | -------------------------------------------- |
| `id: 140`              | `name: "users/{username}/conversations/140"` |
...
- [ ] Update resource identifiers from numeric IDs to resource names (e.g. `users/{username}/conversations/140`)
