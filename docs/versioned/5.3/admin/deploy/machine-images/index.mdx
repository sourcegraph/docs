...
<Callout type="note">While our images are free to try, you may be charged by your cloud provider for the resources required to run the image.</Callout>
...
<Callout type="note">The use of [external services](../external_services/) such as managed Postgres databases or third party object storage services is not supported when using Sourcegraph Machine Images.</Callout>
...
<img src="https://user-images.githubusercontent.com/68532117/195904844-9257c7cd-f9b2-4d15-9c7f-a2d66a42c5df.png" alt="ami-diagram"/>
