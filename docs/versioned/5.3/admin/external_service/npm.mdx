...
{/* <div markdown-func=jsonschemadoc jsonschemadoc:path="admin/external_service/npm-packages.schema.json">[View page on our docs](/integration/npm) to see rendered content.</div> */}
