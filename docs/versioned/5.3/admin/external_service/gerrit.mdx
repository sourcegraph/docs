...
{/* <div markdown-func=jsonschemadoc jsonschemadoc:path="admin/external_service/gerrit.schema.json">[View page on our docs](/admin/external_service/gerrit) to see rendered content.</div> */}
