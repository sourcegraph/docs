...
Once the connection to private artifact registry is established, customer might then verify that auto-indexing is working with private artifact registry by [configuring auto-indexing](/code_navigation/how-to/configure_auto_indexing)
