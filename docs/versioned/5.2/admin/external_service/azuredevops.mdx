...
{/* <div markdown-func=jsonschemadoc jsonschemadoc:path="admin/external_service/azuredevops.schema.json">[View page on docs](https://sourcegraph.com/docs/admin/external_service/azuredevops) to see rendered content.</div> */}
