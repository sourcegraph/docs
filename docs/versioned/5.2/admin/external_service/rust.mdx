...
{/* <div markdown-func=jsonschemadoc jsonschemadoc:path="admin/external_service/rust-packages.schema.json">[View page on docs](/integration/rust) to see rendered content.</div> */}
