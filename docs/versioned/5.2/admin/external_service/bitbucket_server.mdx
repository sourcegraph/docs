...
{/* <div markdown-func=jsonschemadoc jsonschemadoc:path="admin/external_service/bitbucket_server.schema.json">[View page on docs](https://sourcegraph.com/docs/admin/external_service/bitbucket_server) to see rendered content.</div> */}
