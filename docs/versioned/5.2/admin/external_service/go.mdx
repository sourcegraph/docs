...
{/* <div markdown-func=jsonschemadoc jsonschemadoc:path="admin/external_service/go-modules.schema.json">[View page on docs](/integration/go) to see rendered content.</div> */}
