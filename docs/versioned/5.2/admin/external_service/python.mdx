...
{/* <div markdown-func=jsonschemadoc jsonschemadoc:path="admin/external_service/python-packages.schema.json">[View page on docs](/integration/python) to see rendered content.</div> */}
