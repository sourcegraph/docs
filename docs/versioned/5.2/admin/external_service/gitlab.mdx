...
{/* <div markdown-func=jsonschemadoc jsonschemadoc:path="admin/external_service/gitlab.schema.json">[View page on docs](https://sourcegraph.com/docs/admin/external_service/gitlab) to see rendered content.</div> */}
