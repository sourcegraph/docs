...
A complete [dashboard reference](https://docs.sourcegraph.com/admin/observability/dashboards) is available for more context on our available service dashboards and panels.

Additional dashboards can also be set up—see [Grafana configuration](#grafana-configuration) for more details.

#### View documentation

On service dashboards, each metric panel has links attached that lead to relevant [alert solutions](https://docs.sourcegraph.com/admin/observability/alerts) or [panel documentation](https://docs.sourcegraph.com/admin/observability/dashboards).
...
> Refer to our [alert solutions reference](https://docs.sourcegraph.com/admin/observability/alerts) for details on specific alerts.
