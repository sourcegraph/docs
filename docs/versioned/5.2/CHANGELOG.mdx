...
- Added a management console environment variable to disable HTTPS
...
- Fixed an issue where the management console would improperly regenerate the TLS cert/key unless `CUSTOM_TLS=true` was set.
