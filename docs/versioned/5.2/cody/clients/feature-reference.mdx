...
<Callout type="note">Please refer to the tier-wise [context fetchng mechanism](/cody/core-concepts/context#context-fetching-mechanism) and [context scope](/cody/core-concepts/context#context-scope) docs for detailed breakdown.</Callout>
