...
<Callout type="info">This troubleshooting method is only valid for Sourcegraph versions >5.2. As of Sourcegraph version 5.3, embeddings are only available to Cody Free and Cody Pro users on the VS Code extension.</Callout>
...
If you’re connected to a Sourcegraph Enterprise instance, ask your site admin to [Configure Code Graph Context](/cody/core-concepts/code-graph) for your Sourcegraph instance. Then, [enable Cody](/cody/clients/enable-cody-enterprise) for your account.
