...
> NOTE: For how to *use* Sourcegraph's OpenTelemetry integrations, refer to the [OpenTelemetry for site administrators documentation](/admin/observability/opentelemetry).
