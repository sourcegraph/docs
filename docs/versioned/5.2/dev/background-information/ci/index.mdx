...
<QuickLink title="Development" icon='installation' href="/dev/background-information/ci/development" description="Contribute changes to Sourcegraph's Buildkite pipelines." />
