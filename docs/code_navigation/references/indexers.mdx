...
| C/C++                 | [scip-clang](https://github.com/sourcegraph/scip-clang)      | 🟡      | ✓          | ✓                | ✓               | ✓          | ✓                | ✗                    |          |
| Java                  | [scip-java](https://sourcegraph.github.io/scip-java/docs/getting-started.html#supported-build-tools)       | 🟢      | ✓          | ✓                | ✓               | ✓*         | ✓                | ✓                    |      |
| Scala                 | [scip-java](https://sourcegraph.github.io/scip-java/docs/getting-started.html#supported-build-tools)      | 🟢      | ✓          | ✓                | ✓               | ✓*         | ✓                | ✓                    |        |
| Kotlin                | [scip-java](https://sourcegraph.github.io/scip-java/docs/getting-started.html#supported-build-tools)       | 🟢      | ✓          | ✓                | ✓               | ✓*         | ✗                | ✓                    |        |
...
| C#                    | [scip-dotnet](https://github.com/sourcegraph/scip-dotnet)     | 🟠      | ✓          | ✓                | ✓               | ✗          | ✓                | ✓                    | `.sln` and `.csproj` |
