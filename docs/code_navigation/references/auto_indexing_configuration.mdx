...
This document details the expected contents of [explicit index job configuration](/code_navigation/how-to/configure_auto_indexing#explicit-index-job-configuration) for a particular repository. Depending on how this configuration is supplied, it may be encoded as JSON.
