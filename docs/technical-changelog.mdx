...
- verify glibc version in postgresql images `(PR #5735)`
  - release: add container test to verify `glibc` version does not get unintentionally upgraded in PostgreSQL container images` Backport 68a8d54c9e8fd0a3ff0286d0141f07372209f19a from #5670
