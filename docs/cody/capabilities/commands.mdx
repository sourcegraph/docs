...
**Site admins** can make a prompt as **promoted**. When creating a prompt, mark the **Set as recommended** checkbox. This setting allows admins to highlight prompts they want users to use. Recommended prompts are marked with an icon next to their name and appear at the top of the prompt list in the Cody chat.
...
<Callout type="note">Custom Commands (legacy) have been deprecated and will no longer be supported.</Callout>
