...
You can mark your prompt as a draft. A draft prompt cannot be seen by anyone but you. You can see and modify your draft prompts via the **Prompt Library** via the Sourcegraph's Web UI.
