...
Let's learn how you can leverage some of the features of Cody chat with different IDE extensions (VS Code, JetBrains) and the Sourcegraph web app.
...
LLM selection for inline edits:
