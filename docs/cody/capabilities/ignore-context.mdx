...
Enterprise instances admins can use the Cody Context Filters to determine which repositories Cody is allowed to use as context in its requests to third-party LLMs. This functionality is currently experimental and is only supported under the following conditions:
