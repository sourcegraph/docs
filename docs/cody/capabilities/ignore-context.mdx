...
This guide will walk you through the process of ignoring certain files or folders in your codebase when using Cody. This feature is currently in an experimental phase, but you can try it out by following the steps below.
