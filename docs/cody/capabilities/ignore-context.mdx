...
<Callout type="note">
	Cody Ignore File functionality is available for all Cody Free, Pro and Enterprise users and is currently in the Experimental stage and only supported with
	VS Code extension.
</Callout>
