...
<Callout type="note">Newer versions of Sourcegraph Enterprise can be configured to use newer models as they are introduced. See [Model Configuration](/cody/clients/model-configuration) for more information.</Callout>
