...
<Callout type="note">Newer versions of Sourcegraph Enterprise (starting from v5.6) can be configured to use newer models as they are introduced. See [Model Configuration](/cody/clients/model-configuration) for more information.</Callout>
