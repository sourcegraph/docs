...
<p className="subtitle">
  Learn how Cody helps you get contextually-aware autocompletions for your
  codebase.
</p>
...
<Callout type="note">Cody autocomplete works only with Anthropic's Claude Instant model. Support for other models will be coming later. Self-hosted customers must update to version 5.0.4 or more to use autocomplete.</Callout>
