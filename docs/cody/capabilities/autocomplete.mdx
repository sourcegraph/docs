...
<Callout type="note">Cody supports and uses a set of models for autocomplete. Learn more about these [here](/cody/capabilities/supported-models#autocomplete).</Callout>

Before configuring the autocomplete feature, it's recommended that you read more about the [Enabling Cody on Sourcegraph Enterprise](/cody/clients/enable-cody-enterprise) guide.
