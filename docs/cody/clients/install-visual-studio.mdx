...
<LinkCards>
  <LinkCard href="https://github.com/sourcegraph/cody-vs/" imgSrc="https://storage.googleapis.com/sourcegraph-assets/Docs/visual-studio-Product-Icon.svg" imgAlt="Cody for Visual Studio (Experimental)" title="Cody for Visual Studio" description="Install Cody's free extension for Visual Studio." />
</LinkCards>
