...
```shell
cody auth whoami
# ✔ Authenticated as USERNAME on https://sourcegraph.example.com
```
...
Running this command will remove the access token from the secure storage of your operating system.
