...
<QuickLink
	...
	description="Recommended configuration for new deployments and most existing instances."
/>

<QuickLink
	title="Legacy: Completions"
	icon="lightbulb"
	href="/cody/enterprise/completions-configuration"
	description="Legacy configuration path for older deployments that still use completions."
/>
