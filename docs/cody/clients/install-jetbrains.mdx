...
For Cody Free users, Claude 3 Sonnet is the default LLM model for Chat and Commands. Users on Cody **Free** and **Pro** can choose from a list of supported LLM models for Chat and Commands.
