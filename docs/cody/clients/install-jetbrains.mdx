...
<video width="1920" height="1080" loop playsInline controls style={{ width: '100%', height: 'auto' }}>
  <source src="https://storage.googleapis.com/sourcegraph-assets/Docs/Media/jetbrains-cody-v6-edit-code.mp4" type="video/mp4"/>
</video>
...
There is an interface in the sidebar for selecting chat context. For Cody Free and Cody Pro users, you can turn the local project context on or off.

Cody Enterprise users also have the option of adding remote repositories from your Sourcegraph instance. You can type the name of your repositories into this interface and select up to 10 repositories. Cody will then search against those repositories and retrieve relevant files to answer your chat prompts.
