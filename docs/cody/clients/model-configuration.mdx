...
1. ["Completions" Configuration](#completions-configuration)
2. [Model Configuration](#model-configuration) (Early Access Program)
...
By defining a provider override in your Sourcegraph site configuration, you are introducing a new namespace to contain models. Or customize the existing provider namespace supplied by Sourcegraph. (e.g. all `"anthropic"` models.). The following is the list of accepted Provider IDs:
| Provider Id        | Description  |
|--------------------| ------------ |
| `default`          | [Cody Gateway](/cody/core-concepts/cody-gateway), which supports many different models from various services |
| `openaicompatible` | Any OpenAI-compatible API implementation                                                                     |
| `aws-bedrock`      | [Amazon Bedrock](https://docs.aws.amazon.com/bedrock/)                                                       |
| `azure-openai`     | [Microsoft Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service/)             |
| `anthropic`        | [Anthropic](https://www.anthropic.com)                                                                       |
| `fireworks`        | [Fireworks AI](https://fireworks.ai)                                                                         |
| `google`           | [GCP Vertex](https://cloud.google.com/vertex-ai/)                                                            |
| `gemini`           | [Google Gemini](http://cloud.google.com/gemini)                                                              |
...
| Provider Id              | Provider type        | Description  |
|--------------------------| -------------------- | ------------ |
| `"default"`              | `"sourcegraph"`      | [Cody Gateway](/cody/core-concepts/cody-gateway), which supports many different models from various services |
| `"openaicompatible"`     | `"openaicompatible"` | Any OpenAI-compatible API implementation                                                                     |
| `"aws-bedrock"`          | `"awsBedrock"`       | [Amazon Bedrock](https://docs.aws.amazon.com/bedrock/)                                                       |
| `"azure-openai"`         | `"azureOpenAI"`      | [Microsoft Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service/)             |
| `"anthropic"`            | `"anthropic"`        | [Anthropic](https://www.anthropic.com)                                                                       |
| `"fireworks"`            | `"fireworks"`        | [Fireworks AI](https://fireworks.ai)                                                                         |
| `"google"` or `"gemini"` | `"google"`           | [Google Gemini](http://cloud.google.com/gemini) and [GCP Vertex](https://cloud.google.com/vertex-ai/)        |
| `openai`                 | `"openai"`           | [OpenAI](http://platform.openai.com)                                                                         |
|                          | `"huggingface-tgi"`  | [Hugging Face Text Generation Interface](https://huggingface.co/docs/text-generation-inference/en/index)     |

<Callout type="note"> The above table shows the intended mapping of Provider Ids to Provider types. You should use the appropriate Provider type in the `"serverSideConfig"` section of your model configuration based on the Provider Id you choose.</Callout>
