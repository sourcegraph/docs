...
If you’re connected to a Sourcegraph Enterprise instance, ask your site admin to [Configure Code Graph Context](/cody/core-concepts/code-graph) for your Sourcegraph instance. Then, [enable Cody](/cody/cody-clients/enable-cody-enterprise) for your account.
