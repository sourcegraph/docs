...
The billing cycle refers to the start date and depends on your account creation date. You can view your current and previous billing cycles from the **My subscription** tab.

### What payment methods are available?

We only support payments through a credit card.

### What happens when I cannot pay or don't want to renew the Pro plan?

If you are on a Pro plan trial, you must add a credit card to your account to continue on a Pro plan. If you do not want to renew Cody Pro, you will automatically downgrade to Cody Free.
