...
-   Add two Fireworks models:
    -   `"fireworks::v1::mixtral-8x7b-instruct"` with "chat" capability - used for "chat" and "fastChat"
...
<Callout type="note">
	Debugging latency-optimized inference is supported in Sourcegraph v6.5 and
	more.
</Callout>
