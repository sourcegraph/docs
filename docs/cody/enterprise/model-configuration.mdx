...
```bash
export INSTANCE_URL="https://sourcegraph.example.com"  # Replace with your Sourcegraph instance URL
...
<Accordion title="Understanding reasoningEffort">
