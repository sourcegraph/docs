...
- **Prefix**: An optional description of the desired output, often derived from predefined [Commands](./../capabilities/commands) that specify tasks the LLM can perform
