...
<p className="subtitle">Learn how Cody Gateway powers the default Sourcegraph provider for completions and embeddings to facilitate Cody features.</p>
...
To enable completions and embeddings provided by Cody Gateway on your Sourcegraph Enterprise instance, make sure your license key is set, and Cody is enabled in your [site configuration](../../admin/config/site_config):
...
- [Code Graph Context: Embeddings](./../embeddings)
...
<Callout type="warning">Sourcegraph Cody Gateway access must be included in your Sourcegraph Enterprise subscription plan. You can verify it by checking it with your account manager. If you are a [Sourcegraph Cloud](../../cloud/index) user, Cody is enabled by default on your instance starting with Sourcegraph 5.1.</Callout>
...
- your Sourcegraph.com account, for [Cody App users](https://sourcegraph.com/get-cody)
