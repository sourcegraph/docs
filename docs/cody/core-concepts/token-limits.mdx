...
**Currently Cody caps inputs to approximately 7,000 tokens and outputs to approximately 1,000 tokens.**  This balances our needs for context space, retrieval accuracy and latency.  We are actively working to increase these limits, and will update this page when we do.

For more information on how Cody builds context, see our [documentation here](docs/cody/core-concepts/context.mdx).
...
Here is a table with the context window sizes and ouput limits for each of our [supported models](docs/cody/capabilities/supported-models.mdx).
