...
<ProductCards>
  ...
  <ProductCard href="/cody/clients/cody-with-sourcegraph" imgSrc="https://storage.googleapis.com/sourcegraph-assets/docs/images/cody/cody-logomark-default.svg" imgAlt="Cody Web" title="Cody for Web (Experimental)" description="Use Cody in the Sourcegraph web app." />
