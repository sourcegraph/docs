# Cody
    ...
    <Callout type="note" title="Beta">Cody is currently in Beta for all users.</Callout>

Cody is a free AI coding assistant that writes, fixes, and maintains your code. Cody understands your entire codebase by leveraging the power of [Code Graph](/cody/core-concepts/code-graph) to gather context, which assists you in writing accurate code.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Cody helps you identify errors in your code and provides code fixes</td>
    </tr>
  </tbody>
</table>
...
Cody is compatible to use with the other Sourcegraph products, like [Code Search](/code_search). You can use Cody's chat to ask questions about your codebase. When you run any search query, you'll find an **Ask Cody** button that takes you to Cody's default chat interface that you can use to ask questions about the codebase.
...
<QuickLink title="Cody Clients" icon='installation' href="/cody/clients" description="Learn about the different clients you can use to explore Cody." />

<QuickLink title="Cody Troubleshooting Guide" icon='theming' href="/cody/troubleshooting" description="Having trouble with Cody? Review our troubleshooting guide for help." />

<QuickLink title="FAQs" icon='presets' href="/cody/faq" description="Learn about some of the frequently asked questions about Cody." />
