...
<Tabs>
  <Tab title="Free">Content for the Free tab.</Tab>
  <Tab title="Standard">Content for Standard tab.</Tab>
</Tabs>
...
<ProductCards>
  ...
  <ProductCard href="https://sourcegraph.com/sign-in?returnTo=/search" imgSrc="https://storage.googleapis.com/sourcegraph-assets/docs/images/cody/cody-logomark-default.svg" imgAlt="Cody Web" title="Cody for Web (Experimental)" description="Use Cody in the Sourcegraph web app." />
