...
Cody is a free and open-source AI coding assistant that writes, fixes, and maintains your code. Cody understands your entire codebase by leveraging the power of [Code Graph](/cody/core-concepts/code-graph) to gather context, which assists you in writing accurate code.
...
<QuickLink title="Cody Use Cases" icon='lightbulb' href="/cody/use-cases/generate-unit-tests" description="Explore some of the handy use cases with Cody and try them yourself." />
