...
<LinkCards>
  <LinkCard href="https://github.com/sourcegraph/sg.nvim" imgSrc="https://storage.googleapis.com/sourcegraph-assets/Docs/neovim-logo.png" imgAlt="Cody for Neovim" title="Neovim Extension (Experimental)" description="Install Cody's free and open source extension for Neovim." />
</LinkCards>
