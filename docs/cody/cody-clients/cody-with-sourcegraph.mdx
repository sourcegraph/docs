...
You can also run predefined, reusable prompts [Cody Commands](./../capabilities/commands) on your Code Search results. These help you generate contextually aware answers for a selected code snippet or the entire codebase. You can run the following commands:
