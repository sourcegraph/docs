...
> NOTE: The Cody app is not yet available for Windows. However, you can use the [Cody extension for VS Code](/cody/cody-clients/install-vscode) on Windows.
...
- If you use [VS Code](/cody/cody-clients/install-vscode) or [JetBrains IntelliJ](/cody/cody-clients/install-jetbrains) IDEs, it's recommended to install their extensions and Ask Cody questions right within your editor

> NOTE: The [JetBrains IntelliJ](/cody/cody-clients/install-jetbrains) extension is in the `Experimental` stage.
...
If you hit these limits, you can request an increased limit by visiting our [Discord](https://discord.com/servers/sourcegraph-969688426372825169) channel for both chats and completions. If you'd like to use your third-party LLM provider instead of Cody Gateway, create your key with Anthropic or OpenAI and [update your app configuration](/cody/cody-clients/app/app_configuration).
