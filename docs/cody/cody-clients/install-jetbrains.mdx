...
<LinkCards>
   <LinkCard href="https://plugins.jetbrains.com/plugin/9682-cody-ai-by-sourcegraph" imgSrc="https://storage.googleapis.com/sourcegraph-assets/docs/images/cody/jb_beam.svg" imgAlt="Cody for JetBrains" title="JetBrains Extension (Beta)" description="Install Cody's free and open source extension for JetBrains." />
</LinkCards>
...
- [Configure code graph context for Sourcegraph.com](/cody/cody-clients/cody-with-sourcegraph#configure-code-graph-context-for-code-aware-answers)
- [Configure code graph context for Sourcegraph Enterprise](/cody/cody-clients/enable-cody-enterprise#enabling-codebase-aware-answers)
