...
Users can only create code insights that include repositories they have access to. Moreover, when creating code insights, the repository field will _not_ validate nor show users repositories they would not have access to otherwise.
...
To understand how this configuration impacts your language stats queries you can use [tracing](/self-hosted/observability/tracing).
