...
This how-to assumes that you already have [created some search insights](/code-insights/quickstart).
...
([More details on using search contexts as filters, and currently supported search filters](/code-insights/explanations/code-insights-filters#context-query-based-search-context-filters).)
