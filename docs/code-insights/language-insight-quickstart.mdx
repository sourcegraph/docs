...
Get started and create your first [language code insight](/code-insights/) in 5 minutes or less.
...
<img
	src="https://sourcegraphstatic.com/docs/images/code_insights/language_quickstart_insight_dark.png"
	class="screenshot"
/>
...
If you are more interested tracking the historical or future result count of an arbitrary Sourcegraph search, [follow this tutorial](/code-insights/quickstart) instead.
