...
_Uses the [detect and track](/code-insights/explanations/automatically-generated-data-series) capture groups insight type_
...
These examples are all for use with the [automatically generated data series](/code-insights/explanations/automatically-generated-data-series) of "Detect and track" Code Insights, using regular expression capture groups.
...
See the most common reasons for why security checks in checkov are skipped
...
_Or [filter teams by repositories](/code-insights/how-tos/filtering-an-insight) in real time_
