...
Here are some common use cases for the [in-search-results aggregations](/code-insights/explanations/search-results-aggregations) powered by code insights.
...
See what topics most frequently appear in "fix [x]" commit messages
