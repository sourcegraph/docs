...
1. Determine if your instance is ready to Upgrade:
    ...
    2. Consult upgrade notes for your deployment type accross the range of your upgrade. ([Kubernetes](/admin/updates/kubernetes), [Docker-compose](/admin/updates/docker_compose), [Server](/admin/updates/server))
