...
-   [Configuring authorization and authentication](/admin/config/authorization-and-authentication) - We recommend starting here for access and permissions configuration before moving on to the more specific pages on these topics.
...
-   [Basic installation guide](/self-hosted/deploy/docker-compose/)
