...
Entitlements can be set as a global default: default entitlements are granted to all users without an explicit grant for another entitlement of the same type. Additional entitlements can be created to give specific users varying degrees of access. For example, you can set up:
