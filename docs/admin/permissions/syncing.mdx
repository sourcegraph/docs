...
can be done on the Account security settings page: `/users/settings/security` - redirects to your settings.
...
1. Navigate to **Settings > Permissions** (Or URL path `/users/settings/permissions` - redirects to your settings)
