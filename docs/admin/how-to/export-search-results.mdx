...
<Callout type="note" title="Note">
	For versions before 5.8, the 'Export Results' action is only available in
	the legacy UI. For versions before 4.0, view the legacy docs at
	[sourcegraph/sourcegraph-search-export](https://github.com/sourcegraph/sourcegraph-search-export#sourcegraph-search-results-csv-export-extension).
</Callout>
