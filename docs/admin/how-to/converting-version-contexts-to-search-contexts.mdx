...
This guide will provide steps for migrating from [version contexts](/code_search/explanations/features#version-contexts-sunsetting) to [search contexts](/code_search/explanations/features#search-contexts) on your private Sourcegraph instance.
...
3. Press `Convert version contexts`. A list of [existing version contexts](/code_search/explanations/features#version-contexts-sunsetting) found in the site configuration will be shown.
