...
<Callout type="note">This feature is in beta and is available in Sourcegraph 5.2.7 and later.</Callout>
...
- Disable access to `5.2.7.254` (AWS / GCP Instance Metadata Service).
