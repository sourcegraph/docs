...
<Callout type="note">This feature is in beta and is available in Sourcegraph 5.2.3 and later.</Callout>
...
See other possible Environment Variables [here](/admin/executors/deploy_executors_binary#step-2-setup-environment-variables).
