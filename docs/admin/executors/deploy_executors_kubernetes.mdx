...
<Callout type="note">This feature is in beta and is available in Sourcegraph 5.3.0 and later.</Callout>
...
- Disable access to `5.3.0.254` (AWS / GCP Instance Metadata Service).
