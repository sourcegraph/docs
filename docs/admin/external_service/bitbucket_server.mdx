...
{/* <div markdown-func=jsonschemadoc jsonschemadoc:path="admin/external_service/bitbucket_server.schema.json">[View page on our docs](/admin/external_service/bitbucket_server) to see rendered content.</div> */}
