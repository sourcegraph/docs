...
{/* <div markdown-func=jsonschemadoc jsonschemadoc:path="admin/external_service/github.schema.json">[View page on our docs](/admin/external_service/github) to see rendered content.</div> */}
