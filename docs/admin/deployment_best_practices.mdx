...
_To get a better idea of your resource requirements for your instance use our [resource estimator](/admin/deploy/resource_estimator).
...
- Requirements to set-up Batch Changes can be found [here](/batch_changes/references/requirements)
