...
1. **Create a new GitHub App** via Sourcegraph, which will set up all of the required permissions and automatically retrieve the credentials
2. **Add an existing GitHub App** by providing the details of an existing GitHub App (required when using GitHub Enterprise Apps)
