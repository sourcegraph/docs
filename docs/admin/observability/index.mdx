...
<QuickLinks>
    <QuickLink title="Metrics and dashboards" icon='lightbulb' href="/admin/observability/metrics" description="Learn about the metrics and dashboards provided out-of-the-box." />
    <QuickLink title="Alerting" icon='theming' href="/admin/observability/alerting" description="Receive notifications about the health of your Sourcegraph deployment." />
    <QuickLink title="Troubleshooting" icon='installation' href="/admin/observability/troubleshooting" description="Investigate a specific production issue with our troubleshooting guide." />
</QuickLinks>
...
* [Alert solutions](https://docs.sourcegraph.com/admin/observability/alerts)
