...
> NOTE: Both critical and warning alerts should be configured; configuring warning does not automatically enable critical.
...
"observability.alerts": [
  {
    ...
    "notifier": {
      ...
      "address": "sourcegraph-admin-team@example.com"
    }
  }
]
```
