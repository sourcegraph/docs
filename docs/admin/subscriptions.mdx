# Paid Sourcegraph Enterprise subscriptions
...
You can [contact Sourcegraph](https://sourcegraph.com/contact/request-info) to purchase a license. This entitles you to a license key (provided immediately after your purchase), which activates Enterprise features on your Sourcegraph instance.
