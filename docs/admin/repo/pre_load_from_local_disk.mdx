...
-   [Docker Compose](/self-hosted/deploy/docker-compose/): you need to perform these steps on the relevant [Docker Compose volumes](/admin/deploy/docker-compose/#manage-storage).
