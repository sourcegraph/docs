...
This page documents how to configure a Sourcegraph instance. For deployment configuration, please refer to the [relevant deployment docs for your deployment type](/admin/deploy/index#deployment-types).

- [Site configuration](/admin/config/site_config)
- [Global and user settings](/admin/config/settings)
- [Code host configuration](/admin/external_service/index) (GitHub, GitLab, and the [Nginx HTTP server](/admin/http_https_configuration).)
...
- [Add user authentication providers (SSO)](/admin/auth/index)
...
- [Add teams](/admin/teams/index) <span class="badge badge-experimental">Experimental</span>
...
- [Update Sourcegraph](/admin/updates/index)
- [Using external services (PostgreSQL, Redis, S3/GCS)](/admin/external_services/index)
- [PostgreSQL Config](/admin/postgres-conf)
- [Disabling user invitations](/admin/user_invitations)
- [Configuring webhooks](/admin/webhooks/index)
...
- [Restore postgres database from snapshot](/admin/config/restore/index)
- [Enabling database encryption for sensitive data](/admin/config/encryption)
- [Configuring Sourcegraph in private networks](/admin/config/private_network)