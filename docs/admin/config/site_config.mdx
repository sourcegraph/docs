...
{/* Last updated: 2025-08-11T21:50:40Z via sourcegraph/sourcegraph@v6.6.6969 */}
```json
{
	...
	// ⚠️  DEPRECATED: Deprecated changes to this section will not be respected.
