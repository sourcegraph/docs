...
```json
{
  ...
  "properties": {
      ...
      "properties": {
        ...
        "subRepoPermissions": {
          ...
          "if": {
            ...
            "required": ["enforceIPRestrictions"]
          },
          "then": {
            "properties": {
              "enabled": { "const": true }
        ...
        "deepSearch.model": {
          ...
          "deprecationMessage": "Configuring a custom model (BYOK) for Deep Search is deprecated."
        },
    ...
    "batchChanges.containerRegistryAllowlist": {
      ...
      "examples": ["docker.io", "artifactory.acme.com"]
    },
      ...
      "properties": {
        "reranker": {
          ...
          "properties": {
            "type": {
              "type": "string",
              "enum": ["sourcegraph", "identity", "cohere", "voyageai"]
            }
          },
          "oneOf": [
            {
    ...
    "entitlements.completionCredits": {
      ...
      "properties": {
        "mode": {
          ...
          "type": "string",
          "default": "disabled",
          "enum": ["disabled", "track", "trackStrict", "enforce"]
        }
      }
    }
  },
  "definitions": {
    ...
    "ModelOverride": {
      ...
      "properties": {
        ...
        "capabilities": {
          ...
          "items": {
            "type": "string",
            "enum": ["autocomplete", "chat", "vision", "reasoning", "edit", "tools", "fallback"]
          },
          "examples": [["chat", "autocomplete", "vision", "reasoning", "edit", "tools"]]
        },
        "category": {
          "type": "string",
          "enum": ["balanced", "speed", "other", "accuracy"],
          "examples": ["balanced"]
        },
        "status": {
          "type": "string",
    ...
    "DefaultModels": {
      ...
      "properties": {
        ...
        "fallbackChat": {
          ...
          "type": "string",
          "examples": [["google::v1::gemini-2.0-flash"]]
        }
      }
    },
    "DefaultModelConfig": {
    ...
    "ServerSideProviderConfigAzureOpenAI": {
      "type": "object",
      "required": ["type", "endpoint", "user", "useDeprecatedCompletionsAPI"],
      "properties": {
        "type": {
          "type": "string",
          "const": "azureOpenAI"
    ...
    "ServerSideModelConfig": {
      ...
      "properties": {
        "type": {
          "type": "string",
          "enum": ["awsBedrockProvisionedThroughput", "awsBedrock", "openaicompatible"]
        }
      },
      "oneOf": [
        {
