...
The library distinguishes between templates and library examples, where library examples are complete batch specs and templates are library examples with variables.
