...
{/* Last updated: 2025-12-08T20:10:31Z via sourcegraph/sourcegraph@v6.11.0 */}
...
```json
{
	...
	// Whether to enable Cody role-based access controls. Only respected if cody.restrictUsersFeatureFlag is not set. See https://sourcegraph.com/docs/admin/access-control
	...
	// Configure completion credits entitlement enablement
