...
If you have an airgapped configuration, you must allowlist the IP address: `34.107.157.31`.

To learn more about telemetry export, refer to the [Architecture page](./architecture.mdx#analytics-and-telemetry).
