...
- [Batch Changes](/batch-changes/)
  - [Batch Changes Configuration](/batch-changes/site-admin-configuration)
  - [Configure Batch Changes webhooks](/admin/config/webhooks/)
...
- [Code Host Integrations](/integration/)
- [Add repositories fro code host](/admin/repo/add) (from a code host or clone URL)
...
- [Repository permissions](/admin/permissions/)
  ...
  - [Configure Batch Changes webhooks](/admin/config/webhooks/)
- [Sourcegraph Worker Services](/admin/workers)
