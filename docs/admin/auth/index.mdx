...
- [Microsoft Entra ID (Azure Active Directory)](#microsoft-entra)
...
When setting up OIDC through [Microsoft Entra](https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-protocols-openid-connect-code), formerly known as Azure Active Directory, the following [OpenID Connect scopes](https://learn.microsoft.com/en-us/entra/identity-platform/scopes-oidc#openid-connect-scopes) are required:
