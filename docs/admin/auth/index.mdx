...
For added security, site admins may enable [passkey-based step-up authentication](/admin/auth/admin-passkeys) to protect sensitive admin actions with an additional layer of authentication.
