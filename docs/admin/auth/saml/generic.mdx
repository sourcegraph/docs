...
-   We have vendor-specific instructions for [Okta](/admin/auth/saml/okta), [Microsoft Entra ID](/admin/auth/saml/azure_ad), and [Microsoft ADFS](/admin/auth/saml/microsoft_adfs)
