...
-   ~~The `sourcegraph/server` container logs for instances using a [single docker container](/self-hosted/deploy/docker-single-container/)~~ (removed in 7.0.0)
...
-   ~~The `sourcegraph/server` container for instances using a [single docker container](/self-hosted/deploy/docker-single-container/)~~ (removed in 7.0.0)
