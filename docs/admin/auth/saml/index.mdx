...
Q: Our identity provider (IdP) is configured with multiple X509 certificates. Does Sourcegraph support this?

A: Yes. Sourcegraph will register all X509 certificates and requests signed with any of them will be accepted.
