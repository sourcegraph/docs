...
helm upgrade -i -f /home/sourcegraph/deploy/install/override.yaml --version 5.3.3 sourcegraph sourcegraph/sourcegraph
...
<Callout type="warning">You must follow the [multi-version upgrade procedure](https://docs.sourcegraph.com/admin/updates/kubernetes#multi-version-upgrade-procedure) if you are attempting a multi-version upgrade.</Callout>
## Downgrade
