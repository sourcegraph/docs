...
3. You need to copy the `reindex.completed` file for the older reindex.

`cp ~/.sourcegraph/data/postgresql/5.10-reindex.completed ~/.sourcegraph/data/postgresql/5.1-reindex.completed`

4. Start the new `sourcegraph/server` container.
