...
<QuickLinks>
    ...
    <QuickLink title="Installation" icon='lightbulb' href="/admin/deploy/kubernetes/" />
    <QuickLink title="Introduction" icon='theming' href="/admin/deploy/kubernetes/kustomize" />
    <QuickLink title="Configuration" icon='installation' href="#" />
    <QuickLink title="Maintenance" icon='presets' href="/admin/deploy/kubernetes/operations" />
