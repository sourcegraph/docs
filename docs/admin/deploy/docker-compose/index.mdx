...
<QuickLink title="DigitalOcean" icon='presets' href="docker-compose/digitalocean" />
<QuickLink title="Google Cloud" icon='installation' href="docker-compose/google_cloud" />
