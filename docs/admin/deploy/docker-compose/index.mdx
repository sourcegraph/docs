...
<QuickLink title="AWS" icon='lightbulb' href="/admin/deploy/docker-compose/aws" />
<QuickLink title="Azure" icon='theming' href="/admin/deploy/docker-compose/azure" />
<QuickLink title="DigitalOcean" icon='presets' href="/admin/deploy/docker-compose/digitalocean" />
<QuickLink title="Google Cloud" icon='installation' href="/admin/deploy/docker-compose/google_cloud" />
...
```bash
  ...
  export SOURCEGRAPH_VERSION="v5.3.2"
