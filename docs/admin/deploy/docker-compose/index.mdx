...
<QuickLink title="AWS" icon='lightbulb' href="aws" />
<QuickLink title="Azure" icon='theming' href="azure" />
<QuickLink title="DigitalOcean" icon='presets' href="digitalocean" />
<QuickLink title="Google Cloud" icon='installation' href="google_cloud" />
...
```bash
  ...
  export SOURCEGRAPH_VERSION="v5.3.1"
