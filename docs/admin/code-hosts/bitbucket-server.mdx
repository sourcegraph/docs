...
{/* Last updated: 2025-12-08T20:10:35Z via sourcegraph/sourcegraph@v6.11.0 */}
...

{
	...
	// Whether or not personal repositories should be excluded or not. When true, Sourcegraph will ignore personal repositories it may have access to. See https://sourcegraph.com/docs/integration/bitbucket-server#excluding-personal-repositories for more information.
