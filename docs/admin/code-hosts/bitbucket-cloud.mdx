...
{/* Last updated: 2025-12-08T20:10:36Z via sourcegraph/sourcegraph@v6.11.0 */}
...
```json
{
	...
	// If non-null, enforces Bitbucket Cloud repository permissions. This requires that there is an item in the [site configuration json](https://sourcegraph.com/docs/admin/config/site-config#auth-providers) `auth.providers` field, of type "bitbucketcloud" with the same `url` field as specified in this `BitbucketCloudConnection`.
	"authorization": {
