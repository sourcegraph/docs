...
![The GitHub Apps page on Sourcegraph](https://sourcegraphstatic.com/docs/images/administration/config/github-apps/github-apps-list-dark.png)
...
![The GitHub App creation page on Sourcegraph, with the default values filled out](https://sourcegraphstatic.com/docs/images/administration/config/github-apps/github-apps-create-dark.png)

4. When you click **Create GitHub App**, you will be redirected to GitHub to confirm the details of the App to be created.

![The GitHub App creation page on GitHub](https://sourcegraphstatic.com/docs/images/administration/config/github-apps/github-app-create-on-gh-dark.png)
...
![The GitHub App installation page on GitHub](https://sourcegraphstatic.com/docs/images/administration/config/github-apps/github-app-install-gh-dark.png)
...
![The GitHub App details page on Sourcegraph](https://sourcegraphstatic.com/docs/images/administration/config/github-apps/github-app-post-create-dark.png)
...
![The GitHub App installation page, with a list of namespaces to select from](https://sourcegraphstatic.com/docs/images/administration/config/github-apps/github-app-multi-install-gh-dark.png)
...
![The GitHub App details page on Sourcegraph, scrolled to show a second new installation](https://sourcegraphstatic.com/docs/images/administration/config/github-apps/github-app-post-multi-install-dark.png)
