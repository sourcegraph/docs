...
-   Your own `example.sourcegraphcloud.com` domain with fully managed [DNS & HTTPS](/self-hosted/http_https_configuration). Optionally, you can [bring your own domain](#custom-domain).
...
-   [Precise code navigation powered by auto-indexing](/code-navigation/auto_indexing)
...
-   [Google Cloud Storage (GCS)](/cloud/logpush_gcs)
-   [Amazon Web Services S3 (AWS)](/cloud/logpush_s3)
