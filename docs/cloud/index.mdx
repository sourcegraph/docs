...
If you're eligible for a cloud instance, you will receive a link to the instance URL once it's provisioned. This normally takes less than one hour during business hours. From there, we recommend using the [onboarding checklist](/getting-started/cloud-instance) to set up your instance quickly.
...
- [Private Resources on AWS via AWS Private Link](/cloud/private_connectivity_aws.md)
- [Private Resources on GCP via GCP Private Service Connect](/cloud/private_connectivity_gcp.md)
- [Private Resources on on-prem data center via Sourcegraph Connect agent](/cloud/private_connectivity_sourcegraph_connect.md)
...
- [Private Resources exposed via alternate public load balancers[Title](../../../sourcegraph/doc/cloud/private_connectivity_public_lb.md)](/cloud/private_connectivity_public_lb.md)
