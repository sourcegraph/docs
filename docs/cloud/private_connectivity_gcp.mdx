...
Once the connection to private artifact registry is established, customer might then verify that auto-indexing is working with private registry dependencies by [configuring auto-indexing](/code-navigation/auto_indexing#configure-auto-indexing)
...
-   Update auto-indexing inference configuration to create additional files from executor secrets for the given programming language - [how to configure auto-indexing](/code-navigation/inference_configuration)
