...
You can close a batch change when you no longer need it, when all changes have been merged, or when you decide not to make changes. A closed batch change still appears in the [batch changes list](/batch_changes/how-tos/viewing_batch_changes). To completely remove it, you can delete the batch change.

Any user with [admin access to the batch change](/batch_changes/explanations/permissions_in_batch_changes#permission-levels-for-batch-changes) can close or delete it.
...
![batch-change-icon](https://sourcegraphstatic.com/docs/images/batch_changes/batch_changes_icon_in_menu.png)

- From this list, click the batch change that you'd like to close or delete
- In the top right, click the **Close** button

![close-batch-change-icon](https://sourcegraphstatic.com/docs/images/batch_changes/closing_batch_change_close_icon.png)
...
![closing_batch_change_close_changesets](https://sourcegraphstatic.com/docs/images/batch_changes/closing_batch_change_close_changesets.png)
...
![delete-batch-change](https://sourcegraphstatic.com/docs/images/batch_changes/closing_batch_change_deleting.png)
