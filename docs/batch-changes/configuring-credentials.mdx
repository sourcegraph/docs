...
When writing a changeset to the code host, the user will reflect the token used (e.g., on GitHub, the user will be the pull request author). This is why a personal access token is preferred for most operations.
