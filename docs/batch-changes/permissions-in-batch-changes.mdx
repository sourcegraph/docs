...
Batch changes can be created under the user's or an organization's namespace. All organization users have admin access to the batch change if placed under an organization namespace.
