...
- Configure the credentials for the code host(s) on which you'll create changesets. Read more about [Configuring user credentials](/batch_changes/how-tos/configuring_credentials) docs on how to add and manage credentials
...
<Callout type="info">See the [batch spec YAML reference](/batch_changes/references/batch_spec_yaml_reference) for more details on how to write batch specs.</Callout>
...
![server-side-batch-change](https://sourcegraphstatic.com/docs/images/batch_changes/ssbc_create_form.png)
...
![ssbc_editor_panels](https://sourcegraphstatic.com/docs/images/batch_changes/ssbc_editor_panels.png)
...
![ssbc_workspace_preview](https://sourcegraphstatic.com/docs/images/batch_changes/ssbc_workspace_preview.png)
...
![ssbc_execution_screen](https://sourcegraphstatic.com/docs/images/batch_changes/ssbc_execution_screen.png)
...
![ssbc_preview_screen](https://sourcegraphstatic.com/docs/images/batch_changes/ssbc_preview_screen.png)
