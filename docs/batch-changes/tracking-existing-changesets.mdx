...
![tracking_existing_changesets_overview](https://sourcegraphstatic.com/docs/images/batch_changes/tracking_existing_changesets_overview.png)
...
You can learn more about how to create a batch spec from our [creating a batch change](/batch_changes/how-tos/creating_a_batch_change) docs.
