...
<Callout type="tip">Read [Creating a batch change](/batch_changes/how-tos/creating_a_batch_change) for more information on these commands.</Callout>

Examples of errors that requires [manual retrying](#manual-retrying-by-re-applying-the-batch-change-spec) are as follows:

- No [Batch Changes credentials](/batch_changes/how-tos/configuring_credentials) have been set up for the affected code host
