...
Batch Changes help you ship large-scale code changes across many repositories and code hosts. You can create pull requests on all affected repositories, and it tracks their progress until they're all merged. You can also preview the changes and update them at any time.
...
<QuickLink title="Create a Batch Change" icon='presets' href="/batch_changes/explanations/introduction_to_batch_changes" description="Learn how Batch Changes works." />
<QuickLink title="Examples" icon='theming' href="/batch_changes/references/requirements" description="Learn about the requirements for running Batch Changes." />
<QuickLink title="Batch Spec Reference" icon='installation' href="https://www.youtube.com/watch?v=GKyHYqH6ggY" description="Watch the Batch Changes demo video to see what it's capable of." />
</QuickLinks>
...
![batch-changes-tracking](https://sourcegraphstatic.com/docs/images/batch_changes/batch_tracking_sourcegraph_prs.png)
...
![batch-changes-charts](https://sourcegraphstatic.com/docs/images/batch_changes/batch_tracking_sourcegraph_prs_burndown.png)

You can also [create a batch change on a monorepo](/batch_changes/how-tos/creating_changesets_per_project_in_monorepos) by specifying which projects to run the script on. A batch change can also be used to track and manage manually created changesets.
