...
When search contexts are [enabled on your private Sourcegraph instance](/code_search/explanations/features#search-contexts), you can create your own search contexts.
