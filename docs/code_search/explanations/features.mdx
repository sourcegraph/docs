...
See the [query syntax](/code_search/reference/queries) and [query reference](/code_search/reference/language) documentation for a comprehensive overview of supported syntax.
