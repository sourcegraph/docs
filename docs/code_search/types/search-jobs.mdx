...
<Callout type="note"> Sourcegraph already offers an [Exhaustive Search](/code_search/how-to/exhaustive) with the `count:all` operator. However, there are certain limitations when generating results within your codebase.</Callout>
