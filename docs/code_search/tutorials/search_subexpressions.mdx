...
[filters](/code_search/reference/queries#keywords-all-searches) like `repo:` and
[operators](/code_search/reference/queries#boolean-operators) like `or`. Compared to [basic examples](/code_search/tutorials/examples), search subexpressions allow more sophisticated queries.
