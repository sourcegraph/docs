...
2. The [indexer](/code-search/code-navigation/writing_an_indexer) for your language.
...
1. **[Upload that generated index](/code-search/code-navigation/precise_code_navigation#setting-up-code-navigation-for-your-codebase)** to your Sourcegraph instance.
