...
Install the [indexer](/code-navigation/writing_an_indexer) for the required programming language of your repository by following the instructions in the indexer's README
...
<Callout type="note">
	...
	[`lsifEnforceAuth`](/admin/config/site_config#lsifEnforceAuth) you need to
...
<Callout type="note">
	...
	code
	navigation](/code-navigation/precise_code_navigation#setting-up-code-navigation-for-your-codebase).
</Callout>
