...
1. Uploading [SCIP data yourself](/code-navigation/how-to/adding-scip-to-workflows) directly from an already-configured build or continuous integration server, as well as
