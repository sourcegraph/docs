...
This guide gives an overview of best practices when defining [auto-index scheduling](/code-navigation/auto-indexing#configure-auto-indexing) and data retention policies as it relates to resource usage (particular the disk requirement for Postgres).
