...
<Callout type="info">
	...
	more about [Auto-indexing](/code-navigation/auto-indexing).
</Callout>
...
<QuickLinks>
	<QuickLink
		href="/code-navigation/how-to/index-a-go-repository"
		icon="installation"
	...
	/>
	<QuickLink
		href="/code-navigation/how-to/index-a-typescript-and-javascript-repository"
		icon="lightbulb"
		imgAlt="Code Navigation"
	...
	/>
	<QuickLink
		href="/code-navigation/precise-code-navigation#supported-languages-and-indexers"
		icon="presets"
		imgAlt="Code Navigation"
		title="Supported languages and indexers"
		description="See all supported languages and their indexers for precise code navigation."
	/>
	<QuickLink
		href="https://sourcegraph.github.io/scip-java/docs/getting-started.html"
		icon="theming"
		imgAlt="Code Navigation"
		title="Index a JVM repository"
	...
	/>
	<QuickLink
		href="/code-navigation/explanations/uploads"
		icon="lightbulb"
		imgAlt="Code Navigation"
