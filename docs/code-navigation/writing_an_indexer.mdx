...
<Callout type="info">
	...
	more about [Auto-indexing](/code-navigation/auto_indexing).
</Callout>
...
<QuickLinks>
	<QuickLink
		href="/code-navigation/how-to/index_a_go_repository"
		icon="installation"
	...
	/>
	<QuickLink
		href="/code-navigation/how-to/index_a_typescript_and_javascript_repository"
		icon="lightbulb"
		imgAlt="Code Navigation"
	...
	/>
	<QuickLink
		href="/code-navigation/how-to/index_other_languages"
		icon="presets"
		imgAlt="Code Navigation"
