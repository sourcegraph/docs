...
- batches: simplify Sourcer interface [#63673](https://github.com/sourcegraph/sourcegraph/pull/63673)
- svelte: Cleanup dependencies [#63691](https://github.com/sourcegraph/sourcegraph/pull/63691)
- batches: remove `batches-github-app-integration`  feature flag [#63701](https://github.com/sourcegraph/sourcegraph/pull/63701)
...
- batches: implement {site,user} credential authenticator for github apps [#63616](https://github.com/sourcegraph/sourcegraph/pull/63616)
...
- batches: allow use of github app token for gitserver push [#63676](https://github.com/sourcegraph/sourcegraph/pull/63676)
- UI changes for batches github app integration [#63683](https://github.com/sourcegraph/sourcegraph/pull/63683)
...
- batches: Add "check" action to validate Github apps connection [#63705](https://github.com/sourcegraph/sourcegraph/pull/63705)
- batches: sign commits created using a GitHub app credential  [#63707](https://github.com/sourcegraph/sourcegraph/pull/63707)
...
<!--
  - Ensure your pull request title is formatted as: domain): $what
  - Add bullet list items for each additional detail you want to cover (see example below)
  - You can edit this after the pull request was merged, as long as release shipping it hasn't been promoted to the public.
  - For more information, please see this how-to [https://www.notion.so/sourcegraph/Writing-a-changelog-entry-dd997f411d524caabf0d8d38a24a878c?](https://www.notion.so/sourcegraph/Writing-a-changelog-entry-dd997f411d524caabf0d8d38a24a878c?)Audience: TS/CSE > Customers > Teammates (in that order).Cheat sheet: domain: source|search|ci|release|plg|cody|local|...
-->
