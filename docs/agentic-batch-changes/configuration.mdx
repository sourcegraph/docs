...
Codex is the default. If your administrator has configured customer-provided credentials for Claude Code but not Codex, Claude Code is preferred instead. You can request either agent in your prompt or [guidance](#guidance-and-skills); the coordinating agent selects it in the plan. This preference does not prevent the other agent from being used.
