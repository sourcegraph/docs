...
Before drafting a plan, the agent researches with [Deep Search](/deep-search). These searches are metered as Deep Search usage against your subscription's credit balance, separately from the agentic batch change's own metering.
