...
<Callout type="note">
	Guidance and skills are loaded by the coordinating Agentic Batch Changes
	agent only. Coding agents used by [coding agent steps](#coding-agent-steps),
	such as Claude Code and Codex, do not receive this customization.
</Callout>
