...
We recommend encoding guidance that works for your organisation via [agent customisation](#customisation).
...
To get set up, just ask the agent for it in your agentic batch change. We recommend encoding processes that work for your organisation via [agent customisation](#customisation).
...
If you prefer, you can guide the agent the an image of your choice instead, or encourage the agent to build on top of particular images. We recommend encoding processes that work for your organisation via [agent customisation](#customisation).
...
All [batch changes capabilities](/batch-spec-yaml-reference) are available to the agent.
