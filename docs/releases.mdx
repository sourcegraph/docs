...
|---------------------------------|-------------------------------|---------------|----------------------------------------------------------|------------------------------------------------------|
| Sourcegraph 5 Release 9 Patch 1 | November 2024                  | ✅             | [Notes](https://sourcegraph.com/docs/CHANGELOG#v5945)     | [Install](https://sourcegraph.com/docs/admin/deploy) |
| Sourcegraph 5 Release 9         | October 2024                  | ✅             | [Notes](https://sourcegraph.com/docs/CHANGELOG#v590)     | [Install](https://sourcegraph.com/docs/admin/deploy) |
