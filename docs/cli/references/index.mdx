# Command reference
Most commands require that the user first [authenticate](cli/quickstart#connect-to-sourcegraph) against their Sourcegraph instance. See `src --help` for a full list of the sub commands available for your release of the `src` cli.
