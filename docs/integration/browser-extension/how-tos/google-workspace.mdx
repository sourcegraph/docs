...
![grant_permissions](https://storage.googleapis.com/sourcegraph-assets/Docs/permissions.png)

Users can disable Sourcegraph at any time by using the toggle in the extension settings:

![disable-extension](https://storage.googleapis.com/sourcegraph-assets/Docs/disable_extension.png)
