...
The easiest way is to install the [Sourcegraph browser extension](../quickstart), which automatically configures the location bar <kbd>src</kbd> shortcut to search Sourcegraph.
