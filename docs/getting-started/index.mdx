...
- [Powerful, flexible query syntax](/code_search/reference/queries)
- [Commit diff search](/code_search/explanations/features#commit-diff-search)
- [Commit message search](/code_search/explanations/features#commit-message-search)
- [Saved search scopes](/code_search/explanations/features#search-scopes)
- [Search contexts to search across a set of repositories at specific revisions](/code_search/explanations/features#search-contexts)
- [Saved search monitoring](/code_monitoring/)

Read the [code search documentation](/code_search/) to learn more and discover the complete feature set. Here's a video to help you get started:
