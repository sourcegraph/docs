...
-   A [Sourcegraph Cloud](/cloud/) instance, or [deploy and configure Sourcegraph](/self-hosted/deploy/) and add repositories
...
-   [Deploy and configure Sourcegraph](/self-hosted/deploy/) and add repositories
